...
class GameViewer(object):
    ...
    def display_score(self, score, totalKilled, totalSaved):
        tk.Label(self.canvas, text="FINAL SCORE", font=("Arial", 30)).pack(anchor=tk.NW)
        tk.Label(self.canvas, text="Killed {}".format(totalKilled), font=("Arial", 15)).pack(anchor=tk.NW)
        tk.Label(self.canvas, text="Saved {}".format(totalSaved), font=("Arial", 15)).pack(anchor=tk.NW)
        tk.Label(self.canvas, text="Score {}".format(score), font=("Arial", 15)).pack(anchor=tk.NW)
